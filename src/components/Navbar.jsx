...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 z-50 w-full flex justify-center items-center">
      <div className="max-w-[1200px] w-full  mx-auto flex justify-between items-center p-4 shadow shadow-white/40 bg-black text-white rounded-b-lg">
        {/* Logo */}
        <div className="flex items-center space-x-2">
          ...
          <span className="font-semibold text-xl bg-gradient-to-r from-yellow-600 via-yellow-400 to-yellow-600 bg-clip-text text-transparent">Palm & Pixel AI</span>
        </div>
